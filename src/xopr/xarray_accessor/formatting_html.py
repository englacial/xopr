# This is a very lightly modified version of:
# https://github.com/pydata/xarray/blob/8796d55a8506f2d3bd50a265ecbc72e3f2f76f18/xarray/core/formatting_html.py
# It is designed to implement a very simple nested dictionary _repr_html_
